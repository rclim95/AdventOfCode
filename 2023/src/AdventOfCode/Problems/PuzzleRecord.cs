// <copyright file="PuzzleRecord.cs" company="PlaceholderCompany">
// Copyright (c) rclim95.
//
...
internal sealed record class PuzzleRecord(int Day, Func<StreamReader, string> Part1, Func<StreamReader, string> Part2);
